...
ggplot(data.frame(x=c(0,10)), aes(x)) +
  ...
  stat_function(fun = function(.x) 157.2 + 19.1*.x, color = "darkgreen", xlim = c(3,4.4)) +
  stat_function(fun = function(.x) 157.2 + 27.2*.x, color = "darkgreen", xlim = c(4.5,6.4)) +
  stat_function(fun = function(.x) 157.2 + 8.5*.x, color = "darkgreen", xlim = c(6.5,10)) +
