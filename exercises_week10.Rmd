...
In the code below I create a logit (mod_3) and probot (mod_4) model. 
...
stargazer(mod_3, mod_4, type = "text")
```


The logit and the probit estimates should be more or less the same after scaling by 1.6. We can check this by multiplying the probit coefficients by 1.6. After making this adjustments, we see that the estimates roughly match up with eachother (see table below).
